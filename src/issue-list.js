...
export default class IssueList extends Component {
  ...
  newIssues() {
    var link = 'https://api.github.com/repos/techlahoma/speakers-wanted/issues?page=' + this.state.octopage.prev;
    this.GetApiData(link);
  }

  olderIssues() {
    var link = 'https://api.github.com/repos/techlahoma/speakers-wanted/issues?page=' + this.state.octopage.next;
    this.GetApiData(link);
  }
  ...
  renderIssuesList = () => {
    ...
    return labels.map(label => {
      ...
      const labelURL =
        label === 'Unlabeled'
          ? 'https://github.com/techlahoma/speakers-wanted/issues?q=is%3Aopen+is%3Aissue+no%3Alabel'
          : `https://github.com/techlahoma/speakers-wanted/labels/${label}`;
  ...
  componentWillMount() {
    this.GetApiData('https://api.github.com/repos/techlahoma/speakers-wanted/issues');
  }
